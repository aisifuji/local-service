...
public interface HCNetSDK extends StdCallLibrary {
      ...
      //"F:\\project\\SVNProject\\local-service\\local-service-core\\src\\main\\resources\\lib\\hik\\HCNetSDK.dll" SpringUtil.getBean(SDKPathSupport.class).getHikSdkPath()
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(SpringUtil.getBean(SDKPathSupport.class).getHikSdkPath(),
            HCNetSDK.class);
    /***宏定义***/
    //常量
...
//	public byte[] byDeviceId = new byte[NAME_LEN];   //设备序列号
//	public float fTemperatureValue;//温度值；单位摄氏度，精确到0.001。若为0xff表示无效值
//	public NET_VCA_POINT struPoint = new NET_VCA_POINT();//人脸框内最高温度点坐标
