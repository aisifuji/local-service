...
public class DeviceException extends RuntimeException {
     ...
     * @param errorCode 异常码
     */
    public DeviceException(String errorCode) {
     ...
     */
    public DeviceException(String errorCode, String... values) {
     ...
     * @param values 对应的占位符 value值
     */
    public DeviceException(String errorCode, Integer... values) {
     ...
     * @param cause 异常链
     */
    public DeviceException(String errorCode, Throwable cause) {
     ...
     * @param values 对应的占位符 value值
     */
    public DeviceException(String errorCode, Throwable cause, String[] values) {
