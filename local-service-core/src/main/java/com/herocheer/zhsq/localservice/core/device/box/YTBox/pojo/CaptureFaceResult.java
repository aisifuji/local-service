...
public class CaptureFaceResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public CaptureFaceResult(Image face_image, java.nio.ByteBuffer face_feature, Image scene_image, String timestamp, String extra_meta) {
  ...
  /**
   * Creates a new CaptureFaceResult RecordBuilder.
   * @return A new CaptureFaceResult RecordBuilder
   */
  public static CaptureFaceResult.Builder newBuilder() {
    return new CaptureFaceResult.Builder();
  }

  /**
   * Creates a new CaptureFaceResult RecordBuilder by copying an existing Builder.
   * @param other The existing builder to copy.
   * @return A new CaptureFaceResult RecordBuilder
   */
  public static CaptureFaceResult.Builder newBuilder(CaptureFaceResult.Builder other) {
    return new CaptureFaceResult.Builder(other);
  }

  /**
   * Creates a new CaptureFaceResult RecordBuilder by copying an existing CaptureFaceResult instance.
   * @param other The existing instance to copy.
   * @return A new CaptureFaceResult RecordBuilder
   */
  public static CaptureFaceResult.Builder newBuilder(CaptureFaceResult other) {
    return new CaptureFaceResult.Builder(other);
  }

  /**
   * RecordBuilder for CaptureFaceResult instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CaptureFaceResult>
    implements org.apache.avro.data.RecordBuilder<CaptureFaceResult> {
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(CaptureFaceResult.Builder other) {
      super(other);
    ...
    /**
     * Creates a Builder by copying an existing CaptureFaceResult instance
     * @param other The existing instance to copy.
     */
    private Builder(CaptureFaceResult other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.face_image)) {
        this.face_image = data().deepCopy(fields()[0].schema(), other.face_image);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder setFaceImage(Image value) {
     ...
     * @return This builder.
     */
    public CaptureFaceResult.Builder setFaceImageBuilder(Image.Builder value) {
      clearFaceImage();
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder clearFaceImage() {
      face_image = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder setFaceFeature(java.nio.ByteBuffer value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder clearFaceFeature() {
      face_feature = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder setSceneImage(Image value) {
     ...
     * @return This builder.
     */
    public CaptureFaceResult.Builder setSceneImageBuilder(Image.Builder value) {
      clearSceneImage();
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder clearSceneImage() {
      scene_image = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder setTimestamp(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder clearTimestamp() {
      timestamp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder setExtraMeta(String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CaptureFaceResult.Builder clearExtraMeta() {
      extra_meta = null;
    ...
    @Override
    public CaptureFaceResult build() {
      try {
        CaptureFaceResult record = new CaptureFaceResult();
        if (face_imageBuilder != null) {
